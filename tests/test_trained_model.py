...
def test_model(prompt: str, use_adapter: bool = True):
    ...
    # Get base path - use environment variable or default
    base_path = os.environ.get("LLM_MODELS_PATH",
                                os.path.expanduser("~/Downloads/My-Projects/Claude-Optimized/Projects/models"))

    cmd = [
        "python3", "-m", "mlx_lm.generate",
        "--model", f"{base_path}/qwen2.5-1.5b-instruct-4bit",
        "--prompt", prompt,
        "--max-tokens", "150",
